...
const AnalyzeSentimentOutputSchema = z.object({
  ...
  keywords: z.array(z.object({ word: z.string(), sentiment: z.enum(['positive', 'negative', 'neutral']) })).optional().describe('Key words or phrases identified and their individual sentiment contribution (positive, negative, or neutral).'),
});
